...
async def send_email_with_report(email_address, attachment_data):
    ...
    <body>
    <p>Hello,<br><br>
       Please find the attached Weekly Report.<br><br>
    </p>
...
def schedule_email_report():
    ...
    scheduler.add_job(download_report_and_send_email, CronTrigger(day_of_week="thu", hour=12, minute=41), args=["RECEIVERS MAIL HERE"])
    scheduler.start()
